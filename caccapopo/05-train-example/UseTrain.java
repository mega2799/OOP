class UseTrain {
    public static void main(String[] args) {
         ...
         * occupazione
         */
        Train t = new Train(1000,300,700,100,100);
        t.reserveFirstClass(100);
        t.reserveSecondClass(200);
        System.out.println("percentuale posti occupati: " + String.format("2.2f",t.getTotOccupancyRatio()) + "%");
        System.out.println("percentuale posti occupati: " + String.format("%2.2f",t.getFirstClassOccupancyRatio()) + "%");
        System.out.println("percentuale posti occupati: " + String.format("%2.2f",t.getSecondClassOccupancyRatio()) + "%");
    }
}
